...
$sql = "INSERT INTO `train`(`train_id`, `TrainName`, `from`, `to`, `TotalDistance`, `BusinessSeatsPr`, `EconomicalSeatsPr`, `StandardSeatsPr`) VALUES ('$id', '$trainName', '$fromstation', '$tostation', '$totaldistance', '$businessSeats', '$economicalSeats', '$standardSeats' );";
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" name="admin_add_train" method="post" style="border:1px solid #ccc " >
        <div class="container">
			<br/>
		<ul>
		<li><h1 class="mainheading mr-0">Add New Train</h1></li>
			...
			<div class="row">
				...
				<div class="col-75">
				    <input class="form-control" type="text" id="id" name="id"  autofocus placeholder="-- Train Id Here --"  disabled>
				</div>
			    </div>
			  ...
			  <div class="row">
				...
				<div class="row">
				  ...
				  <button   style="width: 550px;" TYPE="Submit" value="Submit" name="submit" id="submit"   class="btn btn-success ">  Add Train</button>
